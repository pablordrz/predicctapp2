...
export default function Register() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-10">
      <h1 className="font-display font-semibold text-2xl mb-1">Crea tu cuenta</h1>
      <p className="text-muted text-sm mb-6">Empiezas con <span className="text-gold font-mono">1.000 pts</span> ficticios para apostar.</p>
